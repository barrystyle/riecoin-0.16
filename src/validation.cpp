...
bool ReadBlockFromDisk(CBlock& block, const CDiskBlockPos& pos, const Consensus::Params& consensusParams)
{
    ...
    // Check the header
    if (!CheckProofOfWork(block.GetHashForPoW(), block.nBits, block.nOffset, consensusParams))
...
bool isAfterFork1(int nHeight, const Consensus::Params& consensusParams)
{
...
bool isInSuperblockInterval(int nHeight, const Consensus::Params& consensusParams)
{
    return (((nHeight / consensusParams.DifficultyAdjustmentInterval()) % 14) == 12);
}

bool isSuperblock(int nHeight, const Consensus::Params& consensusParams)
{
    return ((nHeight % consensusParams.DifficultyAdjustmentInterval()) == 144
             && isInSuperblockInterval(nHeight, consensusParams));
}
