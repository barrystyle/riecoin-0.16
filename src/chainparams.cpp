...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("e1ea18d0676ef9899fbc78ef428d1d26a2416d0f0441d46668d33bcb41275740"));
        assert(hashGenesisBlockForPoW == uint256S("26d0466d5a0eab0ebf171eacb98146b26143d143463514f26b28d3cded81c1bb"));
        assert(genesis.hashMerkleRoot == uint256S("d59afe19bb9e6126be90b2c8c18a8bee08c3c50ad3b3cca2b91c09683aa48118"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1392079740, MinPrimeSizeCompacted, 1, 0 * COIN);
        hashGenesisBlockForPoW = genesis.GetHashForPoW();
